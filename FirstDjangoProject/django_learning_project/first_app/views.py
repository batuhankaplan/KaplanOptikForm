...
def course(request, item):
    try:
        ...
        return HttpResponseNotFound("Not found! Plase look for another course!")
        #raise Http404("Not found! Please look for another page.")
...
def course_number_view(request, num1):
    ...
    try:
        ...
        return HttpResponseNotFound("Not found! Please leave me alone!")   